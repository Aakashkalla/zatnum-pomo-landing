...
const NavBar = () => {
    return (
        <nav className="sticky top-0 z-50 bg-neutral-900/70 backdrop-blur-md text-neutral-600 w-full font-inter p-8 px-10">
            <div className="flex items-center justify-between">
                ...
                {/* CTA */}
                <Button color="primary" href="" text="Start Focusing" classname="tracking-tight px-10 py-4 font-semibold"></Button>
            </div>
        </nav>
    )
}
